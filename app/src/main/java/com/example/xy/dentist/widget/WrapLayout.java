...
public class WrapLayout extends ViewGroup {
     ...
     * @param mb 下外边距
     */
    public void setDatass(String[] data,Context context,int textSize,int pl,int pt,int pr,int pb,int ml,int mt,int mr,int mb){
        createChild(data,context,textSize, pl, pt, pr, pb, ml, mt, mr, mb);
    }

    public void setDatass(List<String> data, Context context, int textSize, int pl, int pt, int pr, int pb, int ml, int mt, int mr, int mb){
        String[] mydata = null;
        if(data!=null){
        ...
        setDatass(mydata,context, textSize,pl, pt, pr, pb, ml, mt, mr, mb);
    }
    ...
    private void createChild(String[] data, final Context context, int textSize, int pl, int pt, int pr, int pb, int ml, int mt, int mr, int mb){
        ...
        for(int i = 0;i<size;i++){
            ...
            if (style == TEXTVIEW_STYLE){
                ...
                ((TextView) btn).setBackgroundResource(R.mipmap.time_enable);
