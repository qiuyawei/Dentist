 ...
 */
public class CaseAdapter2 extends BaseAdapter {
    ...
    int flag;
    public CaseAdapter2(Context context, List<CaseBean2> data, int flag) {
    ...
    @Override
    public CaseBean2 getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CaseBean2 bean = getItem(position);
        ViewHolder hodler;
        if (convertView == null) {
