...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    public static OkHttpClient getOkHttpClient(){
        Api retrofitManager = sRetrofitManager.get(HostType.NETEASE_DRIVER);
        if (retrofitManager == null) {
            retrofitManager = new Api(HostType.NETEASE_DRIVER);
            sRetrofitManager.put(HostType.NETEASE_DRIVER, retrofitManager);
        }
