 ...
 * 包含年月日
 */
public class TimeSelectorBirthday {
    ...
    public TimeSelectorBirthday(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    public TimeSelectorBirthday(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.dialog_selector_birthday);
