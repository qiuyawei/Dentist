...
public class WheelView<T> extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        controlWidth = ApiConstants.SCREEN_WITH/itemNumber;
        if (controlWidth != 0) {
            setMeasuredDimension((int) controlWidth, itemNumber * unitHeight);
//            controlWidth = 1000;
        }

        LogUtils.print("controlWidth",controlWidth);
        LogUtils.print(" ApiConstants.SCREEN_WITH/3", ApiConstants.SCREEN_WITH/3);
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if(dataList.get(i) instanceof  String ){
                itmItemObject.id = i;
            itmItemObject.itemText = (String) dataList.get(i);
            }else if(dataList.get(i) instanceof AreaBean){
                itmItemObject.id = Integer.parseInt(((AreaBean) dataList.get(i)).id);
                itmItemObject.itemText = ((AreaBean) dataList.get(i)).areaName;
            }
            itmItemObject.x = 0;
    ...
    private void drawLine(Canvas canvas) {
        ...
        if (linePaint == null) {
            linePaint = new Paint();
            linePaint.setColor(Color.parseColor("#4C10C4"));
      ...
      /*  canvas.drawLine(0, controlHeight / 2 - unitHeight / 2 + 2, controlWidth, controlHeight / 2 - unitHeight / 2 + 2, linePaint);
        canvas.drawLine(0, controlHeight / 2 + unitHeight / 2 - 2, controlWidth, controlHeight / 2 + unitHeight / 2 - 2, linePaint);*/
        canvas.drawRect(0, controlHeight / 2 - unitHeight / 2 + 2, controlWidth, controlHeight / 2 + unitHeight / 2 - 2, linePaint);
    }
    ...
    public void setDefault(String value){
        int i = 0;
        for (ItemObject index : itemList){
            if (index.itemText.equals(value)){
